  ...
  return (
    <div className="space-y-5">
      ...
      <section className="card p-5 sm:p-6 animate-fade-in-up">
        <h2 className="font-bold text-navy-800">📋 Publicar cardápio</h2>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="block w-full text-sm text-slate-600 file:mr-3 file:cursor-pointer
          ...
          {preview && (
            <div className="overflow-hidden rounded-xl ring-1 ring-slate-200 animate-fade-in">
      ...
      <section className="card overflow-hidden animate-fade-in-up">
        <div className="border-b border-slate-100 px-5 py-4">
          <h2 className="font-bold text-navy-800">Histórico de cardápios</h2>
            ...
            {menus.map((m) => (
              ...
              >
                ...
                <img
                  src={m.image_url}
                  alt={m.title}
                  className="h-14 w-14 shrink-0 rounded-lg bg-slate-100 object-cover ring-1 ring-slate-200"
                />
